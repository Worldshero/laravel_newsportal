            ...
            <div class="container" style="margin-top:80px">
              <div class="row">
                          <div class="col-md-4 col-lg-4 col-sm-4">
                            <div class="card" style="width: 18rem;" id="coursedetail">
                                <ul class="list-group list-group-flush">
                                    @php $i=0;  $xyz = array();@endphp
                                    @php $j=1;  $backbtn = array();@endphp
                        ...
                        <div class="col-md-8 col-sm-7 col-lg-8" >
                          ...
                          <div class="inline ">
                            <a class=" btn btn-primary scs" id="backbtn" data-id="{{$backbtn->id}}"  > Back<i class="fas fa-arrow-left"></i></a>
                            <a class="btn btn-primary scs"  id="nextbtn"  style="float:right" > Next<i class="fas fa-arrow-right"></i> </a>
                    </div></div>
                        </div>
                        </div>
                <br><br>
